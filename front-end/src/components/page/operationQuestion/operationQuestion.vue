<template>
    ...
    <div class="black">
      ...
      <span class="second_class">第{{questionid}}套操作题</span>&nbsp;
    </div>
    <div class="question_answer">
      ...
      <div class="question_items" >
        ...
        <div class="question_item d_jump" v-for="(item,index) in operationData1">
            ...
            <div class="question_intro" v-html="item.ask"></div>
        </div>
...
import {getOperationData} from '../../../api/getData.js'
export default {
  data () {
    return {
      questionid: '',
  ...
  methods: {
    _getData () {
      ...
      getOperationData(data).then((res) => {
        this.lockstatus = res.UNLOCK
